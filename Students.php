...
<div class="form-group">
  <label class="col-xs-4 control-label" for="lrn">ID No.</label>  
  <div class="col-xs-6">
  <input id="lrn" name="lrn" type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="0000000 " maxlength="7" placeholder="0000000" maxlength="12" class="form-control input-xs" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <table id="students" class="table table-bordered table-condensed">
    <thead>
      <tr id="heads">
        <th style="width:10%;text-align:center">ID No.</th>
        <th style="width:30%;text-align:center">Full Name</th>
    ...
    ?>
      <tr>
        ...
        <td><?php echo ucwords($row['LASTNAME']) . ', ' . ucwords($row['FIRSTNAME']). ' ' . $row['MIDDLENAME'] ?></td>
