...
.panel{
  ...
  overflow-x: auto;
          ...
          <h1 class="page-header">Archive Students </h1>


       <div class="col-md-12"> 
       <div class="row">
      <div class="alert alert-success" id="correct"> Student is now on Archived!</div>
        </div>   
  ...
  <center> <button class="btn btn-warning" type="submit">Archive</button></center>
