...
success:function(data)
{
   $("#fetch-feild").html(data);
    ...
    ?>
          ...
          <h1 class="page-header"><?php echo ucwords($row['LASTNAME']) . ', ' . ucwords($row['FIRSTNAME']). ' ' . $row['MIDDLENAME'] ?></h1>
          <?php
    } mysqli_close($conn);
      ?>
      <div class="col-md-5">
      ...
      <label for="focusedInput">Select Year Level:</label>
 ...
 <?php
    ...
    <div class="col-md-12">
      ...
      <label style="font-size:6" for="">SEM</label>
...
<br>
      ...
      <label style="font-size:6" for="">Total number of years in college</label>
  ...
  <div class="row">
   ...
   <br><br>
     ...
     <label style="font-size:10px" for="">To be classified as</label>
        ...
        <br><br>
     <label style="font-size:10px" for="">Total Number of<br>years in college</label>
