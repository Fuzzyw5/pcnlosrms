...
<body>
	<div class="col-lg-12">
                    <center><h2 class="text-dark" style="margin-top: 45px;">Alumni Request Page</h2></center>
					<hr>
					...
					<div class="row col-md-6 col-md-offset-3">
						<div class="panel panel-succes">
							<div class="panel-body">
										...
										<label style="text-align: left;">S.Y Graduated:</label>
										<input style="text-transform: capitalize;" maxlength="9" placeholder="YYYY-YYYY" type="text" name="studentid" id="studentid" class="form-control" required>
									</div>
						<div class="form-group">
