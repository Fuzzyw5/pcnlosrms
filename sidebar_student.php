...
<li>
    <a href="javascript:void(0)" data-toggle="collapse" data-target="#recordsCollapse"><i class="fa fa-envelope-o"> </i>&nbsp;  Request<i class="fa fa-fw fa-caret-down"></i></a>
    <ul class="collapse" id="recordsCollapse">
        <li>
            <a href="rms.php?page=studenth"><i class="fa fa-fw fa-files-o"></i>COE/COG/TOR</a>
        </li>
</ul>
