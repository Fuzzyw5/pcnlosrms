...
<ul id="masterlistCollapse" class="collapse">
    ...
    <li class="">
        <a href="rms.php?page=program"><i class="fa fa-fw fa-bars"></i> Course List</a>
    </li>
</ul>
</li>
<li>
    ...
    <li>
            <a href="rms.php?page=home2"><i class="fa fa-fw fa-files-o"></i>Notification Request </a>
        </li>
        <li>
            <a href="rms.php?page=records"><i class="fa fa-fw fa-files-o"></i>Student Records </a>
        </li>
        <li>
            <a href="rms.php?page=candidates&sy=<?php echo $school_year ?>"><i class="fa fa-fw fa-users"></i> Students to Archive</a>
        </li>
        <li>
            <a href="rms.php?page=candidates_list&sy=<?php echo $school_year ?>"><i class="fa fa-fw fa-file-o"></i> Archive </a>
        </li>
    </ul>
</li>
<li>
    ...
    <ul id="reportsCollapse" class="collapse">
        <li>
            <a href="rms.php?page=report"><i class="fa fa-fw fa-files-o"></i> Record Sheet</a>
        </li>
        <li>
            <a href="rms.php?page=candidates_report&school_year=<?php echo $school_year ?>" ><i class="fa fa-fw fa-file-text-o"></i> Studen Archived</a>
        </li>
    </ul>
</li>
<li>
