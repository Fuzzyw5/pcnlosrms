    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: blue">
                ...
                <a class="navbar-brand" href=""><b>&nbsp; <img src="Logo.png" alt="..." width="7%" height="130%" >&nbsp;Philippine College of Northwestern Luzon</b></a>
            </div>
            ...
            <ul class="nav navbar-right top-nav" style="background-color: blue">
                ...
                <?php echo ucwords($_SESSION['fname'])?>
                    <b class="caret"></b></a>
...
$page = $_GET['page'];
$pages = array( 'studenth2', 'Signup', 'home', 'home2', 'Students', 'studenth', 'subjects','student_p','records','record','addrecord','report','program','statistical','form137','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs', 'fetch', 'addnew', 'conn');
if (!empty($page)) {
