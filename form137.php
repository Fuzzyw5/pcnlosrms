...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>Student Grading System</b></center></p>
		  ...
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>STUDENT'S GRADE RECORDS</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		?>
			<tr>
				...
				<label for="">Date of Birth:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
					...
					<h style="font-size:12px"><?php echo ucwords($row['ADDRESS']) ?></h>
				</td>
			...
			<td style="width:1000px;font-size:12px;align:left">
					...
					<label for="">Address of Parent or Guardian:&nbsp&nbsp&nbsp&nbsp</label>
		...
		<table>
			...
			<label style="font-size:12px">SEM:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
			</td>
		...
		<tr>
		<td style="width:150px;border:1px solid black;font-size:12px;"><center><b>Course Code</b></center></td>
		<td style="width:60px;border:1px solid black;font-size:12px;"><center><b>Grades</b></center></td>
		<td style="width:60px;border:1px solid black;font-size:12px;"><center><b>Units</b></center></td>
		<td style="width:10px;border:1px solid black;font-size:12px;"><center><b>P/F</b></center></td>
		</tr>
		<?php
		$syi = $row1['SYI_ID'];
		...
		?>
		<tr>
		<td style="width:150px;border:1px solid black;font-size:10px;height:15px"> <center>
			<?php
		...
		<td style="width:60px;border:1px solid black;font-size:10px;height:15px"><center><?php echo $row2['UNITS'] ?></center></td>
