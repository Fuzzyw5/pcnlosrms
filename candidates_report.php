    ...
    #stud{
      ...
      top:0px;
		...
		#stud{
          ...
          <h1 class="page-header">List of Archived Students      <button type="text" class="btn btn-info" onclick="printContent('stud')" >
	...
	<tr>
		...
		<p><b>Student Archived System</b></p>
		<p>Philippine College of Northwestern Luzon</p>
