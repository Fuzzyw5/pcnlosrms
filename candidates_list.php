...
.panel{
  ...
  overflow-x: auto;
          ...
          <h1 class="page-header">Students Remove from List</h1>


       <div class="col-md-12"> 
       <div class="row">
      <div class="alert alert-success" id="correct"> Student is now removed from the list!</div>
        </div>   
  ...
  <center> <button class="btn btn-danger" onclick="confirm('ARE YOU SURE YOU WANT THEM TO REMOVED FROM LIST?')" type="submit">Remove</button></center>
    ...
    ?>
      <tr>
        ...
        <td><?php echo $row['LASTNAME'] . "," , ' ' . ucwords($row['FIRSTNAME']). ' ' . $row['MIDDLENAME'] ?></td>
